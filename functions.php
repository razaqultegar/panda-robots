...
function panda_accent_color()
{
    ...
    .panda-custom-dropdown-item:hover,mark-shy-text,.post-type-archive-product .product .product-content_price .onsale div:nth-child(1),.single-product #product_header .product-header_price .onsale div:nth-child(1)
